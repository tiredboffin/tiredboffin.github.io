...
[This article](notes/fujifilm-camera-history.md), together with the [CPU-and-OS History Table](/notes/fujifilm-camera-table.md), is meant to help you determine which models are related or even nearly identical from a reverse-engineering perspective.
