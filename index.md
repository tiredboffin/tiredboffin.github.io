...
[This article](notes/fujifilm-camera-history.md), together with the [CPU-and-OS History Table](https://github.com/tiredboffin/fffw/wiki/CPU-and-OS-History-Table), is meant to help you determine which models are related or even nearly identical from a reverse-engineering perspective.
